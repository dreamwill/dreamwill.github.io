...
2. 新建连接
    ...
    ![1.png](/assets/images/install_mqtt/1.png)

3. 成功建立连接后点击新建订阅

    ![2.png](/assets/images/install_mqtt/2.png)

4. 订阅主题设置为 hello

    ![3.png](/assets/images/install_mqtt/3.png)
...
5. 发送 hello 主题的消息
    ...
    ![4.png](/assets/images/install_mqtt/4.png)
