...
!!! warning
    ...
    下面的命令是在主机 ipa-server.xuwangwei.test 上执行的。
...
1. 用浏览器打开https://ipa-server.xuwangwei.test
    ...
    ![截屏2023-08-27 02.49.37.png](/assets/images/截屏2023-08-27-02.49.37.png)

2. 输入用户名admin和密码后进入管理页面

    ![20230903171821.jpg](/assets/images/20230903171821.jpg)
...
!!! warning
    ...
    下面的命令是在主机 machine1.xuwangwei.test 上执行的。
...
6. 查看Web管理页面
    ...
    ![截屏2023-12-10-10.20.52.png](/assets/images/截屏2023-12-10-10.20.52.png)
